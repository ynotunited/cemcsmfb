  ...
  <div class="wrap">
    <div class="page-header-inner">
      <div>
        ...
        <h1 class="page-title reveal d1">Home Improvement<br/><span class='text-gradient'>Loan</span></h1>
      </div>
      <p class="page-desc">Finance your home renovation and improvement projects. Available to CNL and Contract Employees.</p>
    </div>
  </div>
</section>
  ...
  <div class="wrap">
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:var(--s16);align-items:start;">
      ...
      <div class="reveal">
        ...
        <h2 class="h-lg" style="margin-bottom:var(--s6);">Transform your home with flexible financing.</h2>
        <p class="body-lg" style="margin-bottom:var(--s6);">The CEMCS MFB Home Improvement Loan is available to both CNL and Contract Employees. Whether you're renovating your kitchen, adding a new room, or upgrading your home's infrastructure, this loan gives you the financial support to make it happen.</p>
        ...
        <div style="display:inline-flex;align-items:center;gap:var(--s3);background:var(--brand-blue-light);border:1px solid var(--brand-blue-mid);border-radius:var(--r-md);padding:var(--s3) var(--s5);margin-bottom:var(--s8);">
          ...
          <div>
            ...
            <div style="font-size:var(--t-sm);font-weight:600;color:var(--brand-blue-dark);">CNL &amp; Contract Employees</div>
          </div>
        </div>
      ...
      <div class="reveal d1">
        <div style="background:var(--surface);border:1px solid var(--border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--s-2);">
          ...
          <div style="padding:var(--s6) var(--s8);">
            <?php
            $features = [
              'Available to CNL and Contract Employees',
              'Finance home renovation and improvement projects',
              'Competitive interest rates',
              'Flexible repayment schedule',
              'Salary-backed repayment via standing order',
