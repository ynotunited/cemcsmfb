  ...
  <div class="wrap">
    <div class="page-header-inner">
      <div>
        ...
        <h1 class="page-title reveal d1">10-14-24 Operation<br/><span class='text-gradient'>No Story Loan</span></h1>
      </div>
      <p class="page-desc">Apply in 10 minutes, approved in 14 hours, funded in 24 hours. For CNL employees.</p>
    </div>
  </div>
</section>
  ...
  <div class="wrap">
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:var(--s16);align-items:start;">
      ...
      <div class="reveal">
        ...
        <h2 class="h-lg" style="margin-bottom:var(--s6);">Fast credit with no complications.</h2>
        <p class="body-lg" style="margin-bottom:var(--s6);">The 10-14-24 Operation No Story Loan is designed exclusively for CNL (Chevron Nigeria Limited) employees. The name says it all — apply in 10 minutes, get approved in 14 hours, and receive your funds within 24 hours. No story, no delays.</p>
