  ...
  <div class="wrap">
    <div class="page-header-inner">
      <div>
        ...
        <h1 class="page-title reveal d1">Target Loans &amp;<br/><span class='text-gradient'>Salary Advances</span></h1>
      </div>
      <p class="page-desc">Purpose-driven loans for Contract Employees and Spy Police with salary domiciliation at CEMCS MFB.</p>
    </div>
  </div>
</section>
  ...
  <div class="wrap">
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:var(--s16);align-items:start;">
      ...
      <div class="reveal">
        ...
        <h2 class="h-lg" style="margin-bottom:var(--s6);">Achieve your financial targets with ease.</h2>
        <p class="body-lg" style="margin-bottom:var(--s6);">The CEMCS MFB Target Loans &amp; Salary Advances product is designed for Contract Employees and Spy Police who have their salary domiciled with CEMCS MFB. This product enables you to access credit for specific financial goals, with repayment conveniently deducted from your salary.</p>
        ...
        <div style="display:inline-flex;align-items:center;gap:var(--s3);background:var(--brand-blue-light);border:1px solid var(--brand-blue-mid);border-radius:var(--r-md);padding:var(--s3) var(--s5);margin-bottom:var(--s8);">
          ...
          <div>
            ...
            <div style="font-size:var(--t-sm);font-weight:600;color:var(--brand-blue-dark);">Contract Employees &amp; Spy Police (Salary Domiciliation Required)</div>
          </div>
        </div>
      ...
      <div class="reveal d1">
        <div style="background:var(--surface);border:1px solid var(--border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--s-2);">
          ...
          <div style="padding:var(--s6) var(--s8);">
            <?php
            $features = [
              'Available to Contract Employees and Spy Police',
              'Salary domiciliation with CEMCS MFB required',
              'Purpose-driven loans for specific financial targets',
              'Salary advance facility available',
              'Automatic repayment via salary deduction',
