  ...
  <div class="wrap">
    <div class="page-header-inner">
      <div>
        ...
        <h1 class="page-title reveal d1">Micro Housing<br/><span class='text-gradient'>Loan</span></h1>
      </div>
      <p class="page-desc">Affordable housing finance for Contract Employees and Spy Police looking to own or build a home.</p>
    </div>
  </div>
</section>
  ...
  <div class="wrap">
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:var(--s16);align-items:start;">
      ...
      <div class="reveal">
        ...
        <h2 class="h-lg" style="margin-bottom:var(--s6);">Own your home with affordable financing.</h2>
        <p class="body-lg" style="margin-bottom:var(--s6);">The CEMCS MFB Micro Housing Loan is designed for Contract Employees and Spy Police who aspire to own or build their own home. This product provides accessible and affordable housing finance to help you achieve your homeownership goals.</p>
        ...
        <div style="display:inline-flex;align-items:center;gap:var(--s3);background:var(--brand-blue-light);border:1px solid var(--brand-blue-mid);border-radius:var(--r-md);padding:var(--s3) var(--s5);margin-bottom:var(--s8);">
          ...
          <div>
            ...
            <div style="font-size:var(--t-sm);font-weight:600;color:var(--brand-blue-dark);">Contract Employees &amp; Spy Police</div>
          </div>
        </div>
        ...
        <div style="background:var(--surface);border:1px solid var(--border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--s-2);">
          ...
          <div style="padding:var(--s6) var(--s8);">
            ...
            $features = [
              ...
              'Finance home purchase or construction',
