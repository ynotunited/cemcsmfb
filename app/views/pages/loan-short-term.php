  ...
  <div class="wrap">
    <div class="page-header-inner">
      <div>
        ...
        <h1 class="page-title reveal d1">Short Term Loan &amp;<br/><span class='text-gradient'>Overdraft Facilities</span></h1>
      </div>
      <p class="page-desc">Quick access to short-term credit and overdraft facilities for corporate companies.</p>
    </div>
  </div>
</section>
  ...
  <div class="wrap">
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:var(--s16);align-items:start;">
      ...
      <div class="reveal">
        ...
        <h2 class="h-lg" style="margin-bottom:var(--s6);">Bridge your cash flow gaps with ease.</h2>
        <p class="body-lg" style="margin-bottom:var(--s6);">The CEMCS MFB Short Term Loan and Overdraft Facilities product is designed for corporate companies that need quick access to working capital. Whether you need to bridge a temporary cash flow gap or fund a short-term business need, this product provides fast and flexible credit solutions.</p>
        ...
        <div style="display:inline-flex;align-items:center;gap:var(--s3);background:var(--brand-blue-light);border:1px solid var(--brand-blue-mid);border-radius:var(--r-md);padding:var(--s3) var(--s5);margin-bottom:var(--s8);">
          ...
          <div>
            ...
            <div style="font-size:var(--t-sm);font-weight:600;color:var(--brand-blue-dark);">Corporate Companies</div>
          </div>
        </div>
