  ...
  <div class="wrap">
    <div class="page-header-inner">
      <div>
        ...
        <h1 class="page-title reveal d1">Current<br/><span class="text-gradient">Account</span></h1>
      </div>
      <p class="page-desc">
        Your typical checking account designed for personal and third-party day-to-day transactions.
      </p>
    </div>
  </div>
</section>
  ...
  <div class="wrap">
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:var(--s16);align-items:start;">
      ...
      <div class="reveal">
        ...
        <h2 class="h-lg" style="margin-bottom:var(--s6);">Unlimited access to your money at all times.</h2>
        <p class="body-lg" style="margin-bottom:var(--s6);">
          CEMCS MFB Current Account provides you with unlimited access to your money at all times. You can manage your business, execute your payments and receive your salary through this account. It is available to both individuals and corporate bodies.
        </p>
      ...
      <div class="reveal d1">
        ...
        <div style="margin-top:var(--s6);background:var(--n-50);border:1px solid var(--border);border-radius:var(--r-lg);padding:var(--s6) var(--s8);">
          <h3 style="font-family:var(--f-display);font-size:var(--t-lg);font-weight:700;letter-spacing:-.01em;margin-bottom:var(--s3);">How to Open a Current Account</h3>
          <p style="font-size:var(--t-sm);color:var(--txt-2);line-height:var(--lh-relaxed);margin-bottom:var(--s5);">
            Download the Current Account Form, complete it, print and submit at our office — or open online instantly.
          </p>
