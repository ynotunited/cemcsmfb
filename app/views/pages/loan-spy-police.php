  ...
  <div class="wrap">
    <div class="page-header-inner">
      <div>
        ...
        <h1 class="page-title reveal d1">Spy Police<br/><span class='text-gradient'>Special Loan</span></h1>
      </div>
      <p class="page-desc">Exclusive loan product designed specifically for Spy Police personnel.</p>
    </div>
  </div>
</section>
  ...
  <div class="wrap">
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:var(--s16);align-items:start;">
      ...
      <div class="reveal">
        ...
        <h2 class="h-lg" style="margin-bottom:var(--s6);">Dedicated financial support for Spy Police.</h2>
        <p class="body-lg" style="margin-bottom:var(--s6);">The CEMCS MFB Spy Police Special Loan is an exclusive loan product designed specifically for Spy Police personnel. Recognising the unique financial needs of security personnel, this product offers tailored credit solutions with terms suited to their employment structure.</p>
        ...
        <div style="display:inline-flex;align-items:center;gap:var(--s3);background:var(--brand-blue-light);border:1px solid var(--brand-blue-mid);border-radius:var(--r-md);padding:var(--s3) var(--s5);margin-bottom:var(--s8);">
          ...
          <div>
            ...
            <div style="font-size:var(--t-sm);font-weight:600;color:var(--brand-blue-dark);">Spy Police Only</div>
          </div>
        </div>
      ...
      <div class="reveal d1">
        <div style="background:var(--surface);border:1px solid var(--border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--s-2);">
          ...
          <div style="padding:var(--s6) var(--s8);">
            <?php
            $features = [
              'Exclusively for Spy Police personnel',
              'Tailored loan terms for security personnel',
              'Competitive interest rates',
              'Flexible repayment schedule',
              'Salary-backed repayment',
